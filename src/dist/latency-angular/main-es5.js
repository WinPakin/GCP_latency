...
var StatisticsService = /** @class */ (function () {
    ...
    StatisticsService.prototype.getLst = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.testLst);
    };
    // temporary testing data generator
    StatisticsService.prototype.createData = function (data) {
        return {
    ...
    StatisticsService.prototype.delete = function () {
        this.testLst.length = 0;
    };
    // test get
    StatisticsService.prototype.testGet = function () {
...
var TestCaseComponent = /** @class */ (function () {
    function TestCaseComponent(statisticsService) {
    ...
    TestCaseComponent.ctorParameters = function () { return [
...
var TestDeleteComponent = /** @class */ (function () {
    function TestDeleteComponent(statisticsService) {
        this.statisticsService = statisticsService;
        this.message = "init";
    }
    TestDeleteComponent.prototype.onDelete = function () {
        this.statisticsService.delete();
    };
    TestDeleteComponent.prototype.ngOnInit = function () {
    };
    TestDeleteComponent.ctorParameters = function () { return [
        { type: _statistics_service__WEBPACK_IMPORTED_MODULE_2__["StatisticsService"] }
    ]; };
...
var TestFormComponent = /** @class */ (function () {
    function TestFormComponent(formBuilder, statisticsService) {
