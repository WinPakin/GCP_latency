...
/***/ "./node_modules/raw-loader/index.js!./src/app/test-case/test-case.component.html":
/*!******************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/test-case/test-case.component.html ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/test-delete/test-delete.component.html":
/*!**********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/test-delete/test-delete.component.html ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "{{ status }}\n<form [formGroup]=\"sendTestForm\" (ngSubmit)=\"onSubmit(sendTestForm.value)\" class=\"p-3 mt-3 shadow-lg rounded\">\n\n        <div class=\"alert alert-danger\" role=\"alert\" *ngIf=\"error.length > 0\">\n                {{ error }}\n        </div>\n        <!-- Test Name -->\n            <div class=\"form-group row\">\n                    <label for=\"testName\" class=\"col-sm-2 col-form-label\">Test Name</label>\n                    <div class=\"col-sm-10\">\n                      <input type=\"text\" class=\"form-control\" id=\"testName\" placeholder=\"function test\" formControlName=\"testName\">\n                    </div>\n            </div>\n        \n        <!-- Infastructure Type -->\n        <fieldset class=\"form-group\">\n            <div class=\"row\">\n            <legend class=\"col-form-label col-sm-2 pt-0\">Infrastructure Type</legend>\n            <div class=\"col-sm-10\">\n                <div class=\"form-check\">\n                <input class=\"form-check-input\" type=\"radio\" id=\"function\" value=\"function\" formControlName=\"infrastructure\">\n                <label class=\"form-check-label\" for=\"function\">\n                    Google Serverless Function \n                </label>\n                </div>\n                <div class=\"form-check\">\n                <input class=\"form-check-input\" type=\"radio\" id=\"multiLayer\" value=\"multiLayer\" formControlName=\"infrastructure\">\n                <label class=\"form-check-label\" for=\"multiLayer\">\n                    Multi Layer Application\n                </label>\n                </div>\n            </div>\n            </div>\n        </fieldset>\n    \n        <!-- Location -->\n        <fieldset class=\"form-group\">\n                <div class=\"row\">\n                    <legend class=\"col-form-label col-sm-2 pt-0\">Location</legend>\n                    <div class=\"col-sm-10\">\n                    <div class=\"form-check\">\n                        <input class=\"form-check-input\" type=\"radio\" id=\"us-central\" value=\"us-central\" formControlName=\"location\">\n                        <label class=\"form-check-label\" for=\"us-central\">\n                        US Central\n                        </label>\n                    </div>\n                    <div class=\"form-check\">\n                        <input class=\"form-check-input\" type=\"radio\" id=\"asia-east\" value=\"asia-east\" formControlName=\"location\">\n                        <label class=\"form-check-label\" for=\"asia-east\">\n                         East Asia\n                        </label>\n                    </div>\n                    <div class=\"form-check\">\n                            <input class=\"form-check-input\" type=\"radio\" id=\"europe-west\" value=\"europe-west\" formControlName=\"location\">\n                            <label class=\"form-check-label\" for=\"europe-west\">\n                                West Europe\n                            </label>\n                            </div>\n                    </div>\n                </div>\n                </fieldset>\n    \n            <!-- Submit Button -->\n            <div class=\"form-group row\">\n              <div class=\"col-sm-10\">\n                <button type=\"submit\" class=\"btn btn-primary\">Test Latency</button>\n              </div>\n            </div>\n    </form>\n"
...
let ApiTestCaseComponent = class ApiTestCaseComponent {
...
ApiTestCaseComponent.ctorParameters = () => [
...
let ApiTestDeleteComponent = class ApiTestDeleteComponent {
    constructor(apiTestService) {
        this.apiTestService = apiTestService;
    }
    onDelete() {
...
ApiTestDeleteComponent.ctorParameters = () => [
    { type: _api_test_service__WEBPACK_IMPORTED_MODULE_2__["ApiTestService"] }
];
...
let ApiTestFormComponent = class ApiTestFormComponent {
    constructor(formBuilder, apiTestService) {
...
ApiTestFormComponent.ctorParameters = () => [
...
let ApiTestService = class ApiTestService {
    constructor(http) {
        this.http = http;
        this.placeholder = {
    ...
    add(data) {
        ...
        let qString = `api/${data.testName}/${data.apiType}`;
        this.http.get(qString).subscribe((res) => {
            this.lst.push(res);
        });
    }
...
/* harmony import */ var _test_case_test_case_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./test-case/test-case.component */ "./src/app/test-case/test-case.component.ts");
...
let HeaderComponent = class HeaderComponent {
    constructor(router, activatedRoute) {
        ...
        router.events.subscribe((data) => {
            if (data.url) {
                this.activePage = data.url.slice(1);
            }
        });
    }
    onSelect(activePage) {
...
/* harmony import */ var mathjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! mathjs */ "./node_modules/mathjs/main/es6/index.js");
...
let StatisticsService = class StatisticsService {
    ...
    // returns observable containing testLst
    getLst() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(this.testLst);
    }
    // temporary testing data generator
    createData(data) {
        return {
            testName: data.testName,
            infrastructure: data.infrastructure,
            location: data.location,
            mean: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])(10, 90),
            median: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])(10, 90),
            max: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])(10, 90),
            min: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])(10, 90),
            std: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])(10, 90),
            lst: Object(mathjs__WEBPACK_IMPORTED_MODULE_4__["random"])([1, 10], 10, 90)[0]
        };
    }
    // delete exsisting tests
    delete() {
        this.testLst.length = 0;
    }
    // test get
    testGet() {
        return this.http.get('api/test/angular');
    }
};
...
/***/ "./src/app/test-case/test-case.component.css":
/*!***************************************************!*\
  !*** ./src/app/test-case/test-case.component.css ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/test-case/test-case.component.ts":
/*!**************************************************!*\
  !*** ./src/app/test-case/test-case.component.ts ***!
  \**************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _statistics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../statistics.service */ "./src/app/statistics.service.ts");



let TestCaseComponent = class TestCaseComponent {
...
TestCaseComponent.ctorParameters = () => [
...
TestCaseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./test-case.component.html */ "./node_modules/raw-loader/index.js!./src/app/test-case/test-case.component.html"),
        styles: [__webpack_require__(/*! ./test-case.component.css */ "./src/app/test-case/test-case.component.css")]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_statistics_service__WEBPACK_IMPORTED_MODULE_2__["StatisticsService"]])
], TestCaseComponent);
...
/***/ "./src/app/test-delete/test-delete.component.css":
/*!*******************************************************!*\
  !*** ./src/app/test-delete/test-delete.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./src/app/test-delete/test-delete.component.ts":
/*!******************************************************!*\
  !*** ./src/app/test-delete/test-delete.component.ts ***!
  \******************************************************/
/*! exports provided: TestDeleteComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TestDeleteComponent", function() { return TestDeleteComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _statistics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../statistics.service */ "./src/app/statistics.service.ts");
...
let TestDeleteComponent = class TestDeleteComponent {
    constructor(statisticsService) {
        this.statisticsService = statisticsService;
        this.message = "init";
    }
    onDelete() {
        this.statisticsService.delete();
    }
    ngOnInit() {
    }
};
TestDeleteComponent.ctorParameters = () => [
    { type: _statistics_service__WEBPACK_IMPORTED_MODULE_2__["StatisticsService"] }
];
TestDeleteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-test-delete',
        template: __webpack_require__(/*! raw-loader!./test-delete.component.html */ "./node_modules/raw-loader/index.js!./src/app/test-delete/test-delete.component.html"),
        styles: [__webpack_require__(/*! ./test-delete.component.css */ "./src/app/test-delete/test-delete.component.css")]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_statistics_service__WEBPACK_IMPORTED_MODULE_2__["StatisticsService"]])
], TestDeleteComponent);
...
let TestFormComponent = class TestFormComponent {
    constructor(formBuilder, statisticsService) {
        this.formBuilder = formBuilder;
        this.statisticsService = statisticsService;
        this.error = "";
        this.sendTestForm = this.formBuilder.group({
            testName: '',
            infrastructure: '',
            location: '',
        });
    ...
    onSubmit(data) {
        ...
        else if (!data.infrastructure || data.infrastructure.length === 0) {
            this.error = "You must select an infrastructure type!";
        }
        else if (!data.location || data.location.length === 0) {
            this.error = "You must select a location!";
        }
        else {
            this.error = "";
            this.statisticsService.add(data);
...
TestFormComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _statistics_service__WEBPACK_IMPORTED_MODULE_3__["StatisticsService"] }
];
...
module.exports = __webpack_require__(/*! /Users/win/Desktop/code/latency/latency-angular/src/main.ts */"./src/main.ts");
